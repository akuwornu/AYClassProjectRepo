...
Here, I conducted sentiment analysis to gauge the sentiments of the key words used in most of the data collected. Using the NRC dictionary, it appeared most organizational press releases studied framed AI in both positive and negative ways. A breakdown of the words showed the massive use of words such as U.S, security, data, ai, including, etc. suggesting majority of the press releases came from government agencies such as the national security, government departments, among others. This means most of the press releases analyzed were from government organizations mainly based on natural disasters like pandemics, hurricanes, etc. But the sentiment analysis of the bigrams from these press releases showed mostly positive sentiments for words like disaster, defense, security and AI. This positive sentiments also meant that on the average, most companies had a positive disposition towards AI in their press releases regarding disasters and crisis.

#What themes and narratives dominate discussions of AI in the context of natural disasters and crises?
In assessing the themes and dominant narrative regarding AI and crisis or natural disasters, the reflection was the readiness of various government institutions to deal with crisis. The defense department, environmental protection agency, are among some of the government institutions that projected a readiness to step into disaster situations. A cursory review of the releases showed the prevalence of themes such as disaster recovery, rescue, government support, etc in these press releases. But the biagrams also showed the dominance of government organizations in the discussion of crisis. Technology also featured prominently, referring to crisis related to technology. The narratives centered mainly around how these organizations responded to disasters and crisis.

#What potential risks and ethical concerns regarding AI usage are highlighted in these communications?
The analysis did not quite show the risks and ethical concerns regarding AI use in the press releases reviewed. This could be due to the fact that the press releases did not address AI use specifically but in most instances, referred to the effect of AI in their disaster/crisis response strategies. 
